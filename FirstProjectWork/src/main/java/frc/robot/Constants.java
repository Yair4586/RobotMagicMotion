...
public final class Constants {
  ...
  public static class ArmConstants{
    public static final int setPoint = 3000;
    public static final double CollectMotorSpeed = 0.5;
    
    public static final int mmVelocity = 5;
    public static final int mmAcceleration = 10;
    public static final int mmJerk = 50;
    ...
    public static final double Differances = 0.01;
  }
